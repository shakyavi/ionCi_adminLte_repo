...
(function($) {
	function autosuggest(callBackUrl, textField, type){
		...
		//update by niraj [neerooze@gmail.com] [jun 08 2012]
		this.type 		= type;
	...
	$.fn.coolautosuggest = function(options) {
		...
		return this.each(function() {
			var obj = new autosuggest(settings.url, $(this),settings.type );
