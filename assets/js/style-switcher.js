...
var styleSwitcher = {
    init: function () {
        ...
        yepnope([
        {
            load: base_url+'assets/css/style-switcher.css'
        },
        {
            load: base_url+'assets/lib/colorpicker/css/colorpicker.css'
        },
        {
            load: base_url+'assets/lib/cssbeautify/cssbeautify.js'
        },
        {
            load: base_url+'assets/lib/colorpicker/js/bootstrap-colorpicker.js',
            complete: function () {
                yepnope([
                {
                    load: 'less!'+base_url+'assets/less/theme.less'
                },
                {
                    load: base_url+'assets/lib/less-1.7.0.min.js',
                    complete: function () {
                        $this.build();
