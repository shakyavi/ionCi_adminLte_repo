...
/**
 * Description of AdminLoggedIn
 *
 * @author ubuntu
 */
class UserLoggedIn extends MyController {
    //put your code here
	...
	public function edit_user($id)
	{
		...
		$this->data['password_confirm'] = array(
			...
			'type' => 'password'
                ...
                Template::render('login/edit_user',  $this->data);
	...
	public function create_group()
	{
		...
		else
		{
            ...
            Template::set_layout('template/admin');
                Template::render('login/create_group',  $this->data);
	...
	{       //echo $id;
		...
		$this->data['group_description'] = array(
         ...
         Template::set_layout('template/admin');
                Template::render('login/edit_group',  $this->data);
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->data['user'] = $this->ion_auth->user($id)->row();
                                                           Template::set_layout('template/admin');
                Template::render('login/deactivate_user',  $this->data);
